(() => {
  ...
  const catalogs = {
    'zh-CN': {
      ...
      'axis.title': '连段图', 'axis.loading': '正在读取连段数据', 'axis.iconStyle': '招式图标样式', 'axis.letters': '字母', 'axis.graphics': '图形', 'axis.importKeys': '导入按键设置', 'axis.keysImported': '已导入按键设置：{file}', 'axis.keysSynced': '已同步客户端按键设置', 'axis.keysInvalid': '这不是有效的 WW Combo Trainer 按键设置文件。',
    ...
    'ja-JP': {
      ...
      'axis.title': 'コンボチャート', 'axis.loading': 'コンボデータを読み込み中', 'axis.iconStyle': '操作アイコン', 'axis.letters': '文字', 'axis.graphics': '図形', 'axis.importKeys': 'キー設定を読み込む', 'axis.keysImported': 'キー設定を読み込みました：{file}', 'axis.keysSynced': 'クライアントのキー設定と同期済み', 'axis.keysInvalid': '有効な WW Combo Trainer キー設定ファイルではありません。',
    ...
    'ko-KR': {
      ...
      'axis.title': '콤보 차트', 'axis.loading': '콤보 데이터 불러오는 중', 'axis.iconStyle': '동작 아이콘 스타일', 'axis.letters': '문자', 'axis.graphics': '도형', 'axis.importKeys': '키 설정 가져오기', 'axis.keysImported': '키 설정을 가져왔습니다: {file}', 'axis.keysSynced': '클라이언트 키 설정 동기화됨', 'axis.keysInvalid': '올바른 WW Combo Trainer 키 설정 파일이 아닙니다.',
