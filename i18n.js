(() => {
  ...
  const catalogs = {
    'zh-CN': {
      ...
      'comments.button': '评论', 'comments.title': '评论区', 'comments.hint': '评论和回复只保存在当前浏览器。', 'comments.empty': '还没有评论', 'comments.emptyHint': '来留下第一条评论吧。', 'comments.inputLabel': '评论内容', 'comments.placeholder': '写下你的评论...', 'comments.replyPlaceholder': '回复 @{name}...', 'comments.reply': '回复', 'comments.cancelReply': '取消回复', 'comments.submit': '发表评论', 'comments.replySubmit': '发表回复', 'comments.count': '{count} 条评论', 'comments.replying': '回复 @{name}', 'comments.guest': '访客', 'comments.tooLong': '评论不能超过 1000 个字符。',
    ...
    'ja-JP': {
      ...
      'comments.button': 'コメント', 'comments.title': 'コメント欄', 'comments.hint': 'コメントと返信はこのブラウザにのみ保存されます。', 'comments.empty': 'まだコメントがありません', 'comments.emptyHint': '最初のコメントを残してください。', 'comments.inputLabel': 'コメント内容', 'comments.placeholder': 'コメントを書く...', 'comments.replyPlaceholder': '@{name} に返信...', 'comments.reply': '返信', 'comments.cancelReply': '返信をキャンセル', 'comments.submit': 'コメントを投稿', 'comments.replySubmit': '返信を投稿', 'comments.count': '{count} 件のコメント', 'comments.replying': '@{name} に返信', 'comments.guest': 'ゲスト', 'comments.tooLong': 'コメントは1000文字以内で入力してください。',
    ...
    'ko-KR': {
      ...
      'comments.button': '댓글', 'comments.title': '댓글', 'comments.hint': '댓글과 답글은 이 브라우저에만 저장됩니다.', 'comments.empty': '아직 댓글이 없습니다', 'comments.emptyHint': '첫 댓글을 남겨 보세요.', 'comments.inputLabel': '댓글 내용', 'comments.placeholder': '댓글을 입력하세요...', 'comments.replyPlaceholder': '@{name}님에게 답글...', 'comments.reply': '답글', 'comments.cancelReply': '답글 취소', 'comments.submit': '댓글 등록', 'comments.replySubmit': '답글 등록', 'comments.count': '댓글 {count}개', 'comments.replying': '@{name}님에게 답글', 'comments.guest': '방문자', 'comments.tooLong': '댓글은 1000자 이내로 입력하세요.',
