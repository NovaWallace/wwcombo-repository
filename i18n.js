(() => {
  ...
  const catalogs = {
    'zh-CN': {
      'sponsor.codesExpand': '展开', 'sponsor.codesCollapse': '收起',
      ...
      'sponsor.button': '投喂作者', 'sponsor.eyebrow': 'SUPPORT', 'sponsor.title': '投喂作者', 'sponsor.thanksBefore': '感谢 ', 'sponsor.thanksAfter': ' 对本项目的支持和赞助。有游戏机器人、AI 群友等需求，欢迎看看免费的菲比 bot。', 'sponsor.description': '椰之城相关工具为完全免费公益性质。潮友们用得舒服、心情好，可以给没用的作者和他的 AI 大人喂口买 token。', 'sponsor.wechat': '微信支付', 'sponsor.alipay': '支付宝', 'sponsor.wechatAlt': '微信支付收款码', 'sponsor.alipayAlt': '支付宝收款码', 'sponsor.note': '打赏时请备注您的社区昵称，方便我们献上感谢。', 'sponsor.sponsors': '赞助者', 'sponsor.sponsorsHint': '感谢每一份支持', 'sponsor.loading': '正在读取赞助名单...', 'sponsor.failed': '赞助名单暂时无法读取', 'sponsor.empty': '暂时还没有公开的赞助记录', 'sponsor.expand': '展开全部（{count} 位）', 'sponsor.id': 'ID', 'sponsor.anonymous': '匿名潮友',
    ...
    'en-US': {
      'sponsor.codesExpand': 'Show', 'sponsor.codesCollapse': 'Hide',
      ...
      'sponsor.button': 'Support the author', 'sponsor.eyebrow': 'SUPPORT', 'sponsor.title': 'Support the author', 'sponsor.thanksBefore': 'Thanks to ', 'sponsor.thanksAfter': ' for supporting and sponsoring this project. If you need a game bot or AI group assistant, take a look at the free Feibi bot.', 'sponsor.description': 'Coconut City tools are completely free and public-welfare projects. If they make your time in the community more comfortable, you can optionally help the author and the AI service cover token costs.', 'sponsor.wechat': 'WeChat Pay', 'sponsor.alipay': 'Alipay', 'sponsor.wechatAlt': 'WeChat Pay QR code', 'sponsor.alipayAlt': 'Alipay QR code', 'sponsor.note': 'Please add your community nickname in the payment note so we can thank you properly.', 'sponsor.sponsors': 'Sponsors', 'sponsor.sponsorsHint': 'Thank you for every bit of support', 'sponsor.loading': 'Loading sponsor list...', 'sponsor.failed': 'The sponsor list is temporarily unavailable', 'sponsor.empty': 'There are no public sponsor records yet', 'sponsor.expand': 'Show all ({count})', 'sponsor.id': 'ID', 'sponsor.anonymous': 'Anonymous supporter',
    ...
    'ja-JP': {
      'sponsor.codesExpand': '表示', 'sponsor.codesCollapse': '閉じる',
      ...
      'sponsor.button': '作者を応援', 'sponsor.eyebrow': 'SUPPORT', 'sponsor.title': '作者を応援', 'sponsor.thanksBefore': '', 'sponsor.thanksAfter': ' の本プロジェクトへのご支援・ご協賛に感謝します。ゲームボットやAIグループアシスタントが必要な方は、無料の菲比botをご覧ください。', 'sponsor.description': '椰之城のツールは完全無料の公益サービスです。便利に感じていただけたら、作者とAIサービスのトークン費用を任意でご支援ください。', 'sponsor.wechat': 'WeChat Pay', 'sponsor.alipay': 'Alipay', 'sponsor.wechatAlt': 'WeChat PayのQRコード', 'sponsor.alipayAlt': 'AlipayのQRコード', 'sponsor.note': 'お支払いの際はコミュニティのニックネームを備考に記入してください。私たちから感謝をお伝えできます。', 'sponsor.sponsors': '支援者', 'sponsor.sponsorsHint': 'すべてのご支援に感謝します', 'sponsor.loading': '支援者リストを読み込み中...', 'sponsor.failed': '支援者リストを一時的に読み込めません', 'sponsor.empty': '公開されている支援記録はまだありません', 'sponsor.expand': 'すべて表示（{count}名）', 'sponsor.id': 'ID', 'sponsor.anonymous': '匿名の潮友',
    ...
    'ko-KR': {
      'sponsor.codesExpand': '보기', 'sponsor.codesCollapse': '접기',
      ...
      'sponsor.button': '작가 후원', 'sponsor.eyebrow': 'SUPPORT', 'sponsor.title': '작가 후원', 'sponsor.thanksBefore': '', 'sponsor.thanksAfter': ' 의 프로젝트 지원과 후원에 감사드립니다. 게임 봇이나 AI 그룹 도우미가 필요하다면 무료 菲比 bot을 확인해 주세요.', 'sponsor.description': '椰之城 관련 도구는 완전히 무료인 공익 프로젝트입니다. 편하게 이용하셨다면 작가와 AI 서비스의 토큰 비용을 선택적으로 후원해 주세요.', 'sponsor.wechat': 'WeChat Pay', 'sponsor.alipay': 'Alipay', 'sponsor.wechatAlt': 'WeChat Pay QR 코드', 'sponsor.alipayAlt': 'Alipay QR 코드', 'sponsor.note': '후원할 때 커뮤니티 닉네임을 메모에 남겨 주세요. 저희가 감사의 마음을 전할 수 있습니다.', 'sponsor.sponsors': '후원자', 'sponsor.sponsorsHint': '모든 후원에 감사드립니다', 'sponsor.loading': '후원자 목록을 불러오는 중...', 'sponsor.failed': '후원자 목록을 잠시 불러올 수 없습니다', 'sponsor.empty': '공개된 후원 기록이 아직 없습니다', 'sponsor.expand': '전체 보기 ({count}명)', 'sponsor.id': 'ID', 'sponsor.anonymous': '익명의 후원자',
