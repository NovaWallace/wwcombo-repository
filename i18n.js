(() => {
  ...
  const catalogs = {
    ...
    'en-US': {
      ...
      'commission.create': 'Post commission', 'commission.createHint': 'Describe the characters and rotation you need so others can submit solutions.', 'commission.title': 'Commission title', 'commission.characters': 'Required characters (up to 3)', 'commission.characterHint': 'Select at least one character.', 'commission.characterCount': '{count} / {max} selected', 'commission.description': 'Detailed rotation requirements', 'commission.publish': 'Post commission', 'commission.publishing': 'Posting commission...', 'commission.characterRequired': 'Select at least one character.',
      ...
      'commission.interestCount': '+1 {count}', 'commission.responseCount': '{count} solutions', 'commission.interested': 'Added +1', 'commission.interestFailed': 'Could not add +1: {error}', 'commission.detail': 'Commission details', 'commission.owner': 'Owner', 'commission.interest': 'I want this too +1', 'commission.uploadResponse': 'Upload solution', 'commission.adoptNote': 'Adoption only marks completion. It does not publish the combo automatically.', 'commission.responses': 'Submitted solutions', 'commission.noResponses': 'No solutions have been submitted yet.',
      'commission.interestLabel': 'Interested', 'commission.responseLabel': 'Solutions', 'commission.created': 'Posted', 'commission.uploadHint': 'This file is saved only as a solution and is not sent for community moderation or auto-published.', 'commission.submitResponse': 'Submit solution', 'commission.responseSuccess': 'The solution was saved to this commission.', 'commission.previewResponse': 'Preview', 'commission.downloadFailed': 'Could not download solution: {error}', 'commission.adopt': 'Adopt', 'commission.adoptConfirm': 'Adopt “{title}”? The commission will be completed, but the combo will not be published automatically.', 'commission.adoptFailed': 'Adoption failed: {error}', 'commission.accepted': 'Accepted', 'commission.withdraw': 'Withdraw commission', 'commission.withdrawConfirm': 'Withdraw “{title}”? All submitted solutions will also be deleted. This cannot be undone.', 'commission.withdrawDone': 'Commission withdrawn.', 'commission.withdrawFailed': 'Could not withdraw commission: {error}',
    ...
    'ja-JP': {
      ...
      'commission.interestCount': '+1 {count}', 'commission.responseCount': '{count} 件の案', 'commission.interested': '+1 済み', 'commission.interestFailed': '+1 に失敗しました：{error}', 'commission.detail': '依頼詳細', 'commission.owner': '依頼者', 'commission.interest': '自分も欲しい +1', 'commission.uploadResponse': '案を投稿', 'commission.adoptNote': '採用は完了マークのみで、コンボは自動公開されません。', 'commission.responses': '投稿された案', 'commission.noResponses': 'まだ案は投稿されていません。',
      'commission.interestLabel': '希望人数', 'commission.responseLabel': '案の数', 'commission.created': '投稿日', 'commission.uploadHint': 'このファイルは依頼案としてのみ保存され、審査や自動公開には送られません。', 'commission.submitResponse': '案を送信', 'commission.responseSuccess': '依頼に案を保存しました。', 'commission.previewResponse': 'プレビュー', 'commission.downloadFailed': '案のダウンロードに失敗：{error}', 'commission.adopt': '採用', 'commission.adoptConfirm': '「{title}」を採用しますか？依頼は完了になりますが、自動公開はされません。', 'commission.adoptFailed': '採用失敗：{error}', 'commission.accepted': '採用済み', 'commission.withdraw': '依頼を取り下げる', 'commission.withdrawConfirm': '「{title}」を取り下げますか？投稿された案も削除され、元に戻せません。', 'commission.withdrawDone': '依頼を取り下げました。', 'commission.withdrawFailed': '依頼の取り下げに失敗：{error}',
    ...
    'ko-KR': {
      ...
      'commission.interestCount': '+1 {count}', 'commission.responseCount': '해답 {count}개', 'commission.interested': '+1 완료', 'commission.interestFailed': '+1 실패: {error}', 'commission.detail': '의뢰 상세', 'commission.owner': '의뢰인', 'commission.interest': '나도 원해요 +1', 'commission.uploadResponse': '해답 업로드', 'commission.adoptNote': '채택은 완료 표시만 하며 콤보를 자동 공개하지 않습니다.', 'commission.responses': '제출된 해답', 'commission.noResponses': '아직 제출된 해답이 없습니다.',
      'commission.interestLabel': '희망 인원', 'commission.responseLabel': '해답 수', 'commission.created': '등록일', 'commission.uploadHint': '이 파일은 의뢰 해답으로만 저장되며 커뮤니티 심사나 자동 공개로 전송되지 않습니다.', 'commission.submitResponse': '해답 제출', 'commission.responseSuccess': '해답이 의뢰에 저장되었습니다.', 'commission.previewResponse': '미리보기', 'commission.downloadFailed': '해답 다운로드 실패: {error}', 'commission.adopt': '채택', 'commission.adoptConfirm': '“{title}”을 채택할까요? 의뢰는 완료되지만 자동 공개되지는 않습니다.', 'commission.adoptFailed': '채택 실패: {error}', 'commission.accepted': '채택됨', 'commission.withdraw': '의뢰 철회', 'commission.withdrawConfirm': '“{title}” 의뢰를 철회할까요? 제출된 해답도 삭제되며 되돌릴 수 없습니다.', 'commission.withdrawDone': '의뢰를 철회했습니다.', 'commission.withdrawFailed': '의뢰 철회 실패: {error}',
