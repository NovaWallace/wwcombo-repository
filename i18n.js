(() => {
  ...
  const catalogs = {
    'zh-CN': {
      ...
      'profile.buttonAria': '用户资料', 'profile.guest': '登记资料', 'profile.title': '用户资料', 'profile.hint': '资料只保存在当前浏览器，投稿时发送给控制端。', 'profile.username': '用户名', 'profile.email': '邮箱', 'profile.privacy': '公开页面显示完整用户名和脱敏邮箱，控制端保存完整邮箱用于撤回核验。', 'profile.save': '保存资料', 'profile.edit': '修改资料', 'profile.missing': '尚未登记', 'profile.required': '上传前请先登记用户名和邮箱。', 'profile.withdrawRequired': '撤回前请登记投稿时使用的用户名和邮箱。', 'profile.saved': '资料已保存在当前浏览器。',
      'upload.title': '上传连段', 'upload.hint': '文件会进入控制台审核，通过后公开。', 'upload.choose': '选择 .wwcombo.json 文件', 'upload.none': '尚未选择文件', 'upload.submit': '提交审核', 'upload.tooLarge': '文件不能超过 1 MB。', 'upload.sending': '正在提交，请稍候。', 'upload.success': '投稿成功，正在等待审核。', 'upload.invalidJson': '文件不是有效的 JSON。',
    ...
    'en-US': {
      ...
      'profile.buttonAria': 'User profile', 'profile.guest': 'Set profile', 'profile.title': 'User profile', 'profile.hint': 'Saved only in this browser and sent with submissions.', 'profile.username': 'Username', 'profile.email': 'Email', 'profile.privacy': 'Your username is public; your email is masked. The control panel keeps the full email for withdrawal checks.', 'profile.save': 'Save profile', 'profile.edit': 'Edit profile', 'profile.missing': 'Not set', 'profile.required': 'Set a username and email before uploading.', 'profile.withdrawRequired': 'Enter the profile used for the submission before withdrawing.', 'profile.saved': 'Profile saved in this browser.',
      'upload.title': 'Upload combo', 'upload.hint': 'The file is published after moderation.', 'upload.choose': 'Choose a .wwcombo.json file', 'upload.none': 'No file selected', 'upload.submit': 'Submit for review', 'upload.tooLarge': 'The file must be 1 MB or smaller.', 'upload.sending': 'Submitting...', 'upload.success': 'Submitted successfully and awaiting review.', 'upload.invalidJson': 'The file is not valid JSON.',
    ...
    'ja-JP': {
      ...
      'profile.buttonAria': 'ユーザー情報', 'profile.guest': '情報を登録', 'profile.title': 'ユーザー情報', 'profile.hint': 'このブラウザにのみ保存され、投稿時に送信されます。', 'profile.username': 'ユーザー名', 'profile.email': 'メール', 'profile.privacy': 'ユーザー名は公開、メールは伏字で表示されます。', 'profile.save': '保存', 'profile.edit': '変更', 'profile.missing': '未登録', 'profile.required': '先にユーザー名とメールを登録してください。', 'profile.withdrawRequired': '投稿時の情報を登録してください。', 'profile.saved': 'このブラウザに保存しました。',
      'upload.title': 'コンボをアップロード', 'upload.hint': '審査後に公開されます。', 'upload.choose': '.wwcombo.json を選択', 'upload.none': 'ファイル未選択', 'upload.submit': '審査に送信', 'upload.tooLarge': 'ファイルは1MB以下にしてください。', 'upload.sending': '送信中です。', 'upload.success': '投稿しました。審査をお待ちください。', 'upload.invalidJson': '有効なJSONではありません。',
    ...
    'ko-KR': {
      ...
      'profile.buttonAria': '사용자 정보', 'profile.guest': '정보 등록', 'profile.title': '사용자 정보', 'profile.hint': '현재 브라우저에만 저장되며 투고 시 전송됩니다.', 'profile.username': '사용자 이름', 'profile.email': '이메일', 'profile.privacy': '사용자 이름은 공개되고 이메일은 마스킹됩니다.', 'profile.save': '저장', 'profile.edit': '수정', 'profile.missing': '미등록', 'profile.required': '먼저 사용자 이름과 이메일을 등록하세요.', 'profile.withdrawRequired': '투고할 때 사용한 정보를 등록하세요.', 'profile.saved': '이 브라우저에 저장했습니다.',
      'upload.title': '콤보 업로드', 'upload.hint': '검토 후 공개됩니다.', 'upload.choose': '.wwcombo.json 파일 선택', 'upload.none': '선택한 파일 없음', 'upload.submit': '검토 요청', 'upload.tooLarge': '파일은 1MB 이하여야 합니다.', 'upload.sending': '전송 중입니다.', 'upload.success': '투고 완료. 검토를 기다려 주세요.', 'upload.invalidJson': '올바른 JSON 파일이 아닙니다.',
