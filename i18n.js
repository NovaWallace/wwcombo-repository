(() => {
  ...
  const catalogs = {
    ...
    'ko-KR': {
      ...
      'commission.interestLabel': '희망 인원', 'commission.responseLabel': '해답 수', 'commission.created': '등록일', 'commission.uploadHint': '이 파일은 의뢰 해답으로만 저장되며 커뮤니티 심사나 자동 공개로 전송되지 않습니다.', 'commission.submitResponse': '해답 제출', 'commission.responseSuccess': '해답이 의뢰에 저장되었습니다.', 'commission.previewResponse': '미리보기', 'commission.downloadFailed': '해답 다운로드 실패: {error}', 'commission.adopt': '채택', 'commission.adoptConfirm': '“{title}”을 채택할까요? 의뢰는 완료되지만 자동 공개되지는 않습니다.', 'commission.adoptFailed': '채택 실패: {error}', 'commission.accepted': '채택됨',
